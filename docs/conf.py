# -*- coding: utf-8 -*-
#
# dkpkg documentation build configuration file, created by
...
project = u'dkpkg'
copyright = u'2014 Bjorn Pettersen'
...
latex_documents = [
  ('index', 'dkpkg.tex', u'dkpkg Documentation',
   u'', 'manual'),
]
